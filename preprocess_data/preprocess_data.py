...
def check_data(dataset_name: str):
    ...
    """
    # original data paths
    origin_OUT_DF = '/Volumes/NoNo/Proj/RA/DyGLib-master/DG_data/{}/{}.csv'.format(dataset_name, dataset_name)
    origin_OUT_FEAT = '/Volumes/NoNo/Proj/RA/DyGLib-master/DG_data/{}/ml_{}.npy'.format(dataset_name, dataset_name)
    origin_OUT_NODE_FEAT = '/Volumes/NoNo/Proj/RA/DyGLib-master/DG_data/{}/ml_{}_node.npy'.format(dataset_name, dataset_name)

    # processed data paths
    OUT_DF = '/Volumes/NoNo/Proj/RA/DyGLib-master/processed_data/{}/ml_{}.csv'.format(dataset_name, dataset_name)
    OUT_FEAT = '/Volumes/NoNo/Proj/RA/DyGLib-master/processed_data/{}/ml_{}.npy'.format(dataset_name, dataset_name)
    OUT_NODE_FEAT = '/Volumes/NoNo/Proj/RA/DyGLib-master/processed_data/{}/ml_{}_node.npy'.format(dataset_name, dataset_name)
...
parser.add_argument('--dataset_name', type=str,
                    choices=['wikipedia', 'reddit', 'mooc', 'lastfm', 'myket', 'enron', 'SocialEvo', 'uci',
                             'Flights', 'CanParl', 'USLegis', 'UNtrade', 'UNvote', 'Contacts','foshan'],
